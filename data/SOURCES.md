...
file is a market snapshot and should be refreshed during draft season.
...
- Forecast points, VORP, model rank, confidence, and value gap are model outputs.
  Current ADP is never used as a forecast feature; it is joined only after the
  independent model ranking is calculated.
